...
// Single shared PocketBase client, used to call Cithara's custom API
// routes (e.g. POST /api/notifications/test) from the frontend.
...
// instead of leaving requests stuck rejected forever behind a
// "Loading…" screen.
